...
function MovieCardd() {
  return (
    <div>
        ...
        <Container> <span>Recommended for you</span>
...
position: relative;
width: 100%;
background: linear-gradient(to bottom, rgba(0,0,0,0)20%, rgba(4, 7, 15, 0.4)30%,rgba(4, 7, 15, 0.7)60%,rgba(4, 7, 15, 1)100%);
display: flex;
...
@media (max-width:768px ) {
    margin-left: 7rem;
    grid-template-columns: repeat(6, minmax(1, 1fr));
